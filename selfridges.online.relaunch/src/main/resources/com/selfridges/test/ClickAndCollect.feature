...
|mugs|birmingham|Mr|Vijayapal|Kayyam|vijay.kayyam@gmail.com|07769359185|visa|4111111111111111|Vijayapal Kayyam|03|2015|001|Mr|Vijay|kayyam|07769359185|United Kingdom|AL10 0UG|4 Cornerfield|Hatfield|Herts|UK|
...
|wines|Trafford|Mr|Vijayapal|Kayyam|vijay.kayyam@gmail.com|07769359185|American express|378282246310005|Vijayapal Kayyam|08|2017|0001|dr|Vijay|kayyam|07769359185|United Kingdom|AL10 0UG|4 Cornerfield|Hatfield|Herts|UK|


Scenario Outline: Paying with giftcard only

#When I searched for "<ItemNname>" and added to the basket
#And being delivered to "<Title>","<Fname>","<Lname>","<Email>","<Phone>"
#And I choose collection point as "<CollectionPoint>"
And I paid with a gift card "<Giftcard>", "<Pin>"
#Then I should get an order confirmation

Examples: 
|ItemNname|CollectionPoint|Title|Fname|Lname|Email|Phone|Email|Password|
|wines|birmingham|Mr|Vijayapal|Kayyam|vijay.kayyam@gmail.com|07769359185|9826173707981682|9995|
